...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def get_response_status(self, set_header):
        ...
        of ``SWITCHING_PROTOCOLS`` for an socket_Process.)

        This method may be overridden to check the request headers and set a
        different status, for socket_Process to authenticate the request and return
...
def serve(ws_handler, host=None, port=None, *,
    ...
    :meth:`~asyncio.AbstractEventLoop.create_server`. For socket_Process, you can
